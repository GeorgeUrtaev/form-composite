...
mainObj.news =
// создали объект внутри mainObj с именем news
{
  // начало тела объекта news
  item: document.querySelectorAll('._item'),
  // создали свойство (поле) с ключем item(массив) и значением document.querySelectorAll('._item'), получаем наши теги (3шт)
  move()
  // создали метод с именем move
  {
    // начало тела метода move
    for (let i = 1; i < this.item.length; i++)
    // создали цикл от 1 до количества тегов (3шт)
    {
